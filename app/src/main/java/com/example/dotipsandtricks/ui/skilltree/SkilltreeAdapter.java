...
import com.example.dotipsandtricks.ui.module.ModuleAdapter;
...
public class SkilltreeAdapter extends RecyclerView.Adapter<SkilltreeAdapter.ViewHolder> {
    ...
    public SkilltreeAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        SkilltreeAdapter.ViewHolder viewHolder = new SkilltreeAdapter.ViewHolder(naveView);
        return viewHolder;
    }
            ...
            public void onClick(View v) {
                ...
                if (cl.getVisibility()==View.GONE){
                    ...
                    call.enqueue(new Callback<List<Skilllevels>>() {
                        @Override
                        public void onResponse(Call<List<Skilllevels>> call, Response<List<Skilllevels>> response) {
                        ...
                        @Override
                        public void onFailure(Call<List<Skilllevels>> call, Throwable t) {
